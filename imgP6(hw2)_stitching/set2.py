...
# https://webnautes.tistory.com/1415 참고자료
...
if __name__ == '__main__':
    img1 = cv.imread('panorama/set2/004.png')
    img2 = cv.imread('panorama/set2/003.png')
    img3 = cv.imread('panorama/set2/002.png')
    img4 = cv.imread('panorama/set2/001.png')

    result = main(img1, img2)
    result2 = main(result, img3)
    result3 = main(result2, img4)
    print(result3.shape)
    ...
    im_out = cv.warpPerspective(result3, h, (im_dst.shape[1], im_dst.shape[0]))
